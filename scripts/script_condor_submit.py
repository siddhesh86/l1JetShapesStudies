...
commands = {
    ...
    # 13_1_0_pre4 HCAL paper study: PFA2
    "2022G_Muon_13_1_0_pre4_HCALPaper_PFA2":  "time python3 L1T_HCALL2Calib_stage1.py  --HcalPUS PFA2   --l1ntuple '/eos/cms/store/group/dpg_trigger/comm_trigger/L1Trigger/ssawant/Muon/L1TNtuple_13_1_0_pre4_forHCALPaper_PFA2_Run2022G-ZMu-PromptReco-v1/230903_122105/0000/L1rates_PFA2_*.root' --sampleName 2022G_Muon_13_1_0_pre4_HCALPaper_PFA2  --PUrangeTag nVtxAll  --l1MatchOffline --l1NtupleChunkyDonut  --offlinePUPPIJet ",
