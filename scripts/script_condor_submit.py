...
commands = {
    ...
    ### 2022/03/16
    #"PFA1p_Run3_QCD_Pt15to7000":  "time python L1T_HCALL2Calib_stage1.py  PFA1p   '/eos/cms/store/group/dpg_trigger/comm_trigger/L1Trigger/ssawant/QCD_Pt15to7000_TuneCP5_14TeV-pythia8/L1TNtuple_forHCalL2Calib_PFA1p_Run3Summer21DR-FlatPU0to80FEVT_castor_120X_mcRun3_2021_realistic_v6-v1/220316_113148/*/'   nVtxAll  ",
    #"PFA1p_Run3_QCD_Pt15to7000":  "time python L1T_HCALL2Calib_stage1.py  --HcalPUS PFA1p   --l1ntuple '/eos/cms/store/group/dpg_trigger/comm_trigger/L1Trigger/ssawant/QCD_Pt15to7000_TuneCP5_14TeV-pythia8/L1TNtuple_forHCalL2Calib_PFA1p_Run3Summer21DR-FlatPU0to80FEVT_castor_120X_mcRun3_2021_realistic_v6-v1/220316_113148/*/L1Ntuple_HCAL_TP_OOT_PUS_PFA1p_97.root'   --PUrangeTag nVtxAll  ",
    #"PFA1p_Run3_QCD_Pt15to7000":  "time python L1T_HCALL2Calib_stage1.py  --HcalPUS PFA1p   --l1ntuple '/eos/cms/store/group/dpg_trigger/comm_trigger/L1Trigger/ssawant/QCD_Pt15to7000_TuneCP5_14TeV-pythia8/L1TNtuple_forHCalL2Calib_PFA1p_CMSSW1230pre1wPR37196_Run3Summer21DR-FlatPU0to80FEVT_castor_120X_mcRun3_2021_realistic_v6-v1/220318_122835/0000/L1Ntuple_HCAL_TP_OOT_PUS_PFA1p_9.root'   --PUrangeTag nVtxAll  --l1MatchGen ",
    #"PFA1p_Run3_QCD_Pt15to7000":  "time /cvmfs/cms.cern.ch/slc7_amd64_gcc900/cms/cmssw/CMSSW_11_2_0/external/slc7_amd64_gcc900/bin/python  L1T_HCALL2Calib_stage1.py  --HcalPUS PFA1p   --l1ntuple '/eos/cms/store/group/dpg_trigger/comm_trigger/L1Trigger/ssawant/QCD_Pt15to7000_TuneCP5_14TeV-pythia8/L1TNtuple_forHCalL2Calib_PFA1p_CMSSW1230pre1wPR37196_Run3Summer21DR-FlatPU0to80FEVT_castor_120X_mcRun3_2021_realistic_v6-v1/220318_122835/0000/L1Ntuple_HCAL_TP_OOT_PUS_PFA1p_9.root'   --PUrangeTag nVtxAll  --l1MatchGen ",
    #"PFA1p_Run3_QCD_Pt15to7000":  "time python  L1T_HCALL2Calib_stage1.py  --HcalPUS PFA1p   --l1ntuple '/eos/cms/store/group/dpg_trigger/comm_trigger/L1Trigger/ssawant/QCD_Pt15to7000_TuneCP5_14TeV-pythia8/L1TNtuple_forHCalL2Calib_PFA1p_CMSSW1230pre1wPR37196_Run3Summer21DR-FlatPU0to80FEVT_castor_120X_mcRun3_2021_realistic_v6-v1/220318_122835/0000/L1Ntuple_HCAL_TP_OOT_PUS_PFA1p_1.root'   --PUrangeTag nVtxAll  --l1MatchGen ", # <<<<<
    #"PFA1p_Run3_QCD_Pt15to7000":  "time python  L1T_HCALL2Calib_stage1.py  --HcalPUS PFA1p   --l1ntuple '/eos/cms/store/group/dpg_trigger/comm_trigger/L1Trigger/ssawant/QCD_Pt15to7000_TuneCP5_14TeV-pythia8/L1TNtuple_forHCalL2Calib_PFA1p_CMSSW1230pre1wPR37196_Run3Summer21DR-FlatPU0to80FEVT_castor_120X_mcRun3_2021_realistic_v6-v1/220318_122835/0000/L1Ntuple_HCAL_TP_OOT_PUS_PFA1p_*.root'   --PUrangeTag nVtxAll  --l1MatchGen ",
    #"PFA1p_Run3_QCD_Pt15to7000":  "time python L1T_HCALL2Calib_stage1.py  --HcalPUS PFA1p   --l1ntuple '/eos/cms/store/group/dpg_trigger/comm_trigger/L1Trigger/ssawant/QCD_Pt15to7000_TuneCP5_14TeV-pythia8/L1TNtuple_forHCalL2Calib_PFA1p_CMSSW1230pre1wPR37196_Run3Summer21DR-FlatPU0to80FEVT_castor_120X_mcRun3_2021_realistic_v6-v1/220318_122835/0*/L1Ntuple_HCAL_TP_OOT_PUS_PFA1p_*.root'   --PUrangeTag nVtxAll  --l1MatchGen ", # 2428 files

    ### 2022/04/13 L1Ntuples PhiRing1    
    "PFA1p_Run3_QCD_Pt15to7000":  "time python L1T_HCALL2Calib_stage1.py  --HcalPUS PFA1p   --l1ntuple '/eos/cms/store/group/dpg_trigger/comm_trigger/L1Trigger/ssawant/QCD_Pt15to7000_TuneCP5_14TeV-pythia8/L1TNtuple_forHCalL2Calib_PFA1p_PhiRing_Run3Summer21DR-FlatPU0to80FEVT_castor_120X_mcRun3_2021_realistic_v6-v1/220413_162531/00*/L1Ntuple_HCAL_TP_OOTPUS_PFA1p_ITPUS_PhiRing_2000.root'   --PUrangeTag nVtxAll  --l1MatchGen ", # 2428 files
}
