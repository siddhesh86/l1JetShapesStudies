...
/*
// RawPUS
std::string sInFile_SFs = "LUTs/Default_RawPUS_SF/lut_calib_2022G_HCALPaper_PFA2_ECALZS_decimal.txt"; 
std::string sOutFile    = "LUTs/Default_RawPUS_SF/lut_calib_2022G_HCALPaper_PFA2_ECALZS.txt"; 
*/

// RawPUS_phiDefault
std::string sInFile_SFs = "LUTs/Default_RawPUS_phiDefault_SF/lut_calib_2022G_HCALPaper_PFA2_ECALZS_decimal.txt"; 
std::string sOutFile    = "LUTs/Default_RawPUS_phiDefault_SF/lut_calib_2022G_HCALPaper_PFA2_ECALZS.txt"; 
