...
# with command line options: l1Ntuple -s RAW2DIGI --python_filename=l1ntuple_maker_2022_data_HCALPaper_PFA1p_try2.py -n 10000 --no_output --era=Run3 --data --conditions=130X_dataRun3_Prompt_v3 --customise=L1Trigger/Configuration/customiseReEmul.L1TReEmulFromRAWsimHcalTP --customise=L1Trigger/L1TNtuples/customiseL1Ntuple.L1NtupleAODRAWEMU --customise=L1Trigger/Configuration/customiseSettings.L1TSettingsToCaloParams_2022_v0_6 --filein=/store/data/Run2023C/Muon0/RAW-RECO/ZMu-PromptReco-v1/000/367/413/00000/bbdaf6d7-a926-45ee-ac69-946cc695a851.root --no_exe
