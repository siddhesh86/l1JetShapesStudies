...
# with command line options: l1Ntuple -s RAW2DIGI --python_filename=l1ntuple_maker_2024_data_14_0_7.py -n 100 --no_output --era=Run3 --data --conditions=140X_dataRun3_Prompt_v2 --customise=L1Trigger/Configuration/customiseReEmul.L1TReEmulFromRAW --customise=L1Trigger/L1TNtuples/customiseL1Ntuple.L1NtupleRAWEMU --customise=L1Trigger/Configuration/customiseSettings.L1TSettingsToCaloParams_2023_v0_4 --filein=/store/data/Run2024E/Muon0/RAW-RECO/ZMu-PromptReco-v1/000/380/956/00000/bc194e2c-3d58-40d6-8953-ea7334ce802c.root --no_exec
