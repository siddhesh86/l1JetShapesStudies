...
# with command line options: l1Ntuple -s RAW2DIGI --python_filename=l1ntuple_maker_run3_mc_rates.py -n 100 --no_output --era=Run3 --mc --conditions=112X_mcRun3_2021_realistic_v15 --customise=L1Trigger/Configuration/customiseReEmul.L1TReEmulFromRAWsimHcalTP --customise=L1Trigger/L1TNtuples/customiseL1Ntuple.L1NtupleRAWEMUCalo --customise=L1Trigger/Configuration/customiseSettings.L1TSettingsToCaloParams_2018_v1_3 --customise_commands=process.HcalTPGCoderULUT.LUTGenerationMode=cms.bool(False) --filein=root://cms-xrd-global.cern.ch//store/mc/Run3Winter20DRPremixMiniAOD/Neutrino_Pt-2to20_gun/GEN-SIM-RAW/SNB_110X_mcRun3_2021_realistic_v6-v1/10000/0010F588-EA5D-1D42-88A0-B1C5FAFC2B28.root --no_exec

## VertexSelector not applicable for RAW samples
...
from L1Trigger.L1TNtuples.customiseL1Ntuple import L1NtupleRAWEMUCalo 

#call to customisation function L1NtupleRAWEMUCalo imported from L1Trigger.L1TNtuples.customiseL1Ntuple
