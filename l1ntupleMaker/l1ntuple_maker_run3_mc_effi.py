...
# with command line options: l1Ntuple -s RAW2DIGI --python_filename=l1ntuple_maker_run3_mc_effi.py -n 100 --no_output --era=Run3 --mc --conditions=112X_mcRun3_2021_realistic_v15 --customise=L1Trigger/Configuration/customiseReEmul.L1TReEmulFromRAWsimHcalTP --customise=L1Trigger/L1TNtuples/customiseL1Ntuple.L1NtupleAODRAWEMUCalo --customise=L1Trigger/Configuration/customiseSettings.L1TSettingsToCaloParams_2018_v1_3 --customise_commands=process.HcalTPGCoderULUT.LUTGenerationMode=cms.bool(False) --filein=root://cms-xrd-global.cern.ch//store/mc/Run3Winter20DRPremixMiniAOD/TTToSemiLeptonic_TuneCP5_14TeV-powheg-pythia8/AODSIM/110X_mcRun3_2021_realistic_v6-v2/230000/D78B2DD8-0718-E44B-BF1E-F88BD034D79C.root --secondfilein=root://cms-xrd-global.cern.ch//store/mc/Run3Winter20DRPremixMiniAOD/TTToSemiLeptonic_TuneCP5_14TeV-powheg-pythia8/GEN-SIM-RAW/110X_mcRun3_2021_realistic_v6-v2/230000/F6B5B4E5-6773-3C46-ADFF-E329C54E27DA.root --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://cms-xrd-global.cern.ch//store/mc/Run3Winter20DRPremixMiniAOD/TTToSemiLeptonic_TuneCP5_14TeV-powheg-pythia8/AODSIM/110X_mcRun3_2021_realistic_v6-v2/230000/D78B2DD8-0718-E44B-BF1E-F88BD034D79C.root'),
    secondaryFileNames = cms.untracked.vstring('root://cms-xrd-global.cern.ch//store/mc/Run3Winter20DRPremixMiniAOD/TTToSemiLeptonic_TuneCP5_14TeV-powheg-pythia8/GEN-SIM-RAW/110X_mcRun3_2021_realistic_v6-v2/230000/F6B5B4E5-6773-3C46-ADFF-E329C54E27DA.root')
)
