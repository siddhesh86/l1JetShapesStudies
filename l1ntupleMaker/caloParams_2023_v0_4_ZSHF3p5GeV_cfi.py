...
caloStage2Params = L1Trigger.L1TCalorimeter.caloParams_cfi.caloParams.clone(
    ...
    jetCompressPtLUTFile       = "L1Trigger/L1TCalorimeter/data/lut_pt_compress_2024Ev0_DCSOnlyJSON_14_0_7_ZSHF3p5GeV.txt",
    jetCompressEtaLUTFile      = "L1Trigger/L1TCalorimeter/data/lut_eta_compress_2024Ev0_DCSOnlyJSON_14_0_7_ZSHF3p5GeV.txt",
    jetCalibrationLUTFile      = "L1Trigger/L1TCalorimeter/data/lut_calib_2024Ev0_DCSOnlyJSON_14_0_7_ZSHF3p5GeV_ECALZS.txt",
    ...
    layer1HFScaleETBins = cms.vint32([4, 6, 9, 12, 15, 20, 25, 30, 35, 40, 45, 55, 70, 256]),
